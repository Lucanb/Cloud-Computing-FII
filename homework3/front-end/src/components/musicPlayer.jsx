    ...
    export default function MusicPlayer(currentSong, currentIndex,songs, setSongs ){
        ...
        const handleDeleteSong = async () => {
            try {
                const response = await fetch(`https://us-central1-homework3-project.cloudfunctions.net/gcp-func-novus/api/songs/deleteOne/${currentSong.currentSong._id}/${user.uid}`, {
                    method: 'DELETE'
                });
                if (!response.ok) {
